...
代码、改稿、措辞、甚至 comment 的内容,都不是我亲手做的——是 AI 做的。我做的是判断、定方向、划边界,在它要漂移的时候拉住它。退到 governance 层。

我得先承认一件事:一开始那种爽是真的。把任务甩出去、看着它自己跑起来、效率翻几倍,那种正反馈会上瘾,我上瘾过。但紧接着的惶恐也是真的,而且越往深用、越深入这件事的人,越惶恐——AI 把活干了,我们人怎么办。

这不是我一个人的拧巴。罗福莉说过一个意思:她原本以为自己的工作够有创造力、不会被 Skill 化、不会被 Workflow 化,后来发现 AI"自己左脚踩右脚就提升了",于是她把问题抛回来——工作越来越多可以交给 AI,人究竟还剩下什么意义和价值。问这个问题的,是站在这个领域最前面的人之一。这说明它不是焦虑,是这个时代摆在所有人面前、而且要长久面对的真问题。

我没有答案。我甚至怀疑这个问题没有解析解,只有天知道。我现在能想到的,不是一个解,是一种姿态:跟自己和解。具体说,是跟那个"以为价值就等于亲手下地干活"的自己和解——如果亲手敲的那部分被拿走了,我得重新找到"我还在场"的依据,而不是守着旧的依据惶恐。

但我必须把诚实推到底,包括拆掉我自己这篇文章的台。我在前面说,govern 这块 AI 吃不掉。说实话,我连这句话本身能不能成立都不确定——"harness 是人类守得住的价值"这个判断,会不会有一天被 AI 自己否决掉。我没有给自己留任何一块"AI 绝对够不到"的安全区,包括 governance,包括这篇文章的结论。

奇点已经过去了。在一个 agent-first world 里,人的价值或许不再是"我做了什么"。又或许,"我们的价值"这个词本身,需要被重新定义。

我不知道。我只是想把这个不知道,诚实地写在这里。
...
<sub>toffee · GitHub [@toffee-desuwa](https://github.com/toffee-desuwa) · 北京交通大学机电学院大二</sub>
